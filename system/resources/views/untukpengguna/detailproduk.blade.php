  ...
  <div class="container">
    <div class="col-md-4 products-left">
      ...
      <div class="categories animated wow slideInUp" data-wow-delay=".5s">
        <h3>Categories</h3>
        <ul class="cate">
          <li><a href="{{url('public')}}">Best Selling</a> <span>(15)</span></li>
          <li><a href="{{url('public')}}">Home Collections</a> <span>(16)</span></li>
          <ul>
            <li><a href="{{url('public')}}">Cookware</a> <span>(2)</span></li>
            <li><a href="{{url('public')}}">New Arrivals</a> <span>(0)</span></li>
            <li><a href="{{url('public')}}">Home Decore</a> <span>(1)</span></li>
          </ul>
          <li><a href="{{url('public')}}">Decorations</a> <span>(15)</span></li>
          <ul>
            <li><a href="{{url('public')}}">Wall Clock</a> <span>(2)</span></li>
            <li><a href="{{url('public')}}">New Arrivals</a> <span>(0)</span></li>
            <li><a href="{{url('public')}}">Lighting</a> <span>(1)</span></li>
            <li><a href="{{url('public')}}">Top Brands</a> <span>(0)</span></li>
          </ul>
        </ul>
      </div>
      <div class="men-position animated wow slideInUp" data-wow-delay=".5s">
        <a href="single.html"><img src="{{url('public')}}/assets/images/29.jpg" alt=" " class="img-responsive" /></a>
    ...
    <div class="col-md-8 single-right">
        ...
        <div class="flexslider">
          <ul class="slides">
            <li data-thumb="images/si.jpg">
              <div class="thumb-image"> <img src="{{url('public')}}/assets/images/si.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="images/si1.jpg">
              <div class="thumb-image"> <img src="{{url('public')}}/assets/images/si1.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
            <li data-thumb="images/si2.jpg">
              <div class="thumb-image"> <img src="{{url('public')}}/assets/images/si2.jpg" data-imagezoom="true" class="img-responsive"> </div>
            </li>
          </ul>
        </div>
        <!-- flixslider -->
        <script defer src="{{url('public')}}/assets/js/jquery.flexslider.js"></script>
        <link rel="stylesheet" href="{{url('public')}}/assets/css/flexslider.css" type="text/css" media="screen" />
        <script>
      ...
      <div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight" data-wow-delay=".5s">
        <h3>{{$produk->nama}}</h3>
        <h4><span class="item_price">200</span></h4>
        <div class="rating1">
    ...
    <div class="new-collections-grids">
      <div class="col-md-3 new-collections-grid">
        <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".5s">
          <div class="new-collections-grid1-image">
            <a href="single.html" class="product-image"><img src="{{url('public')}}/assets/images/8.jpg" alt=" " class="img-responsive"></a>
      ...
      <div class="col-md-6 new-collections-grid">
        <div class="new-collections-grid1-sub">
          <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".6s">
            <div class="new-collections-grid1-image">
              <a href="single.html" class="product-image"><img src="{{url('public')}}/assets/images/6.jpg" alt=" " class="img-responsive"></a>
              <div class="new-collections-grid1-image-pos">
                <a href="single.html">Quick View</a>
              </div>
              <div class="new-collections-grid1-right">
        ...
        <div class="new-collections-grid1-sub">
          <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".7s">
            <div class="new-collections-grid1-image">
              <a href="single.html" class="product-image"><img src="{{url('public')}}/assets/images/9.jpg" alt=" " class="img-responsive"></a>
              <div class="new-collections-grid1-image-pos">
                <a href="single.html">Quick View</a>
              </div>
              <div class="new-collections-grid1-right">
      ...
      <div class="col-md-3 new-collections-grid">
        <div class="new-collections-grid1 animated wow slideInLeft" data-wow-delay=".8s">
          <div class="new-collections-grid1-image">
            <a href="single.html" class="product-image"><img src="{{url('public')}}/assets/images/11.jpg" alt=" " class="img-responsive"></a>
            <div class="new-collections-grid1-image-pos">
              <a href="single.html">Quick View</a>
            </div>
            <div class="new-collections-grid1-right">
