		...
		<table class="table">
          ...
          @foreach($list_produk as $produk)
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="detail.html">{{$produk->nama}}</a></h4>
						<div class="row">
							<div class="col-sm-12">
						...
						<div class="cart-product-info">
											<span class="product-color">COLOR:<span>{{$produk->color}}</span></span>
						</div>
					</td>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price">Rp {{($produk->harga)}}</span></td>
					<td class="cart-product-grand-total"><span class="cart-grand-total-price">Rp {{($produk->harga)}}</span></td>
          @endforeach
				</tr>
			</tbody><!-- /tbody -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<a href="{{url('/template.chekout')}}"type="submit" class="btn btn-primary checkout-btn">PROCCED TO CHEKOUT</a>
...
<!-- For demo purposes – can be removed on production : End --> 
  ...
  <script src="{{url('public')}}/assets/js/scripts.js"></script></body></body>
